...
\author{Wayne Baumgartner\supit{a}, Steven D. Christe\supit{a} and Barry B. Author2\supit{b}
\skiplinehalf
\supit{a}cNASA Goddard Space Flight Center, Address, Greenbelt, U.S.; \\
...
\authorinfo{Further author information: (Send correspondence to S.D.C.)\\A.A.A.: E-mail: steven.d.christe@nasa.gov, Telephone: 1 505 123 1234\\  B.B.A.: E-mail: bba@cmp.com, Telephone: +33 (0)1 98 76 54 32}
...
\keywords{HERO, CdTe, X-ray optics, X-ray imaging, focal plane array}
...
%-------------
   ...
   \begin{center}
   \begin{tabular}{c}
   \includegraphics[height=7cm]{../figures/mcr3b.pdf}
   \end{tabular}
   \end{center}
   \caption[example] 
